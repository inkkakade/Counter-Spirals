...
Lo = 2;                             %Square Box
H = Lo/2;                           %Depth
lambda = Lo/2;                      %Wavelength on Basilisk
%fo = sqrt(g/(2*pi*lambda));         
k = 2*pi/lambda;                    %Wave Number

max_sigma = 5;                      %Maximum value for Surface Tension (sigma) used in Basilisk)
delta_sigma = 0.1;                 %Step size of sigma
...
for i = 0:delta_sigma:max_sigma
  myfilename = sprintf('data_02_07/Dispersion/wave-128-%g.txt', i);
